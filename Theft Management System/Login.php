      ...
      <div class="col-md-4"></div>
       <div class="col-md-4 bg-dark rounded">
        <div class="container rounded">
            <form class="form-login hover" method="post" action="validation.php">
                  <a href="#"><img class="rounded-circle" src="Images/img6.jpg" alt="Logo" style="height: 80px;width: 80px;margin-left: 40%;"></a>
                <h4 class="form-login-heading h4 text-center glow" style="color: #fff;"><b>Login Form</b></h4>
              ...
              <div class="login-wrap">
                ...
                <!-- Add an additional element to display password requirements -->
                   ...
                   <button class="btn btn-theme btn-block form-control btn-primary rounded"  type="submit"
                          name="btn_add" id="submit"><i class="fa fa-user"></i> Login</button>
                  <br>
